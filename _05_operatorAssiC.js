function expression(gradScore,hscScore,sscScore,name){
    ...
    var result= (gradScore>=70 || hscScore>=80  || sscScore>=90) ?`Congrates, ${name} you are elligible  for TCS interview`: 
    ` ${name} Unfortunatly you are not elligible for interview`;
